...
class _PLVideoPlayerState extends State<PLVideoPlayer>
  ...
  void _onInteractionEnd(ScaleEndDetails details) {
    ...
    if (plPlayerController.isSliderMoving.value) {
      if (plPlayerController.cancelSeek == true) {
        plPlayerController.onUpdatedSliderProgress(plPlayerController.position);
      } else {
  ...
  Widget build(BuildContext context) {
    ...
    if (PlatformUtils.isDesktop) {
      return Obx(() {
        final keepWindowControls = Platform.isWindows && !isFullScreen;
        if (!keepWindowControls) {
          plPlayerController.keepControlsVisible = false;
        }
        return MouseRegion(
          ...
          onEnter: (_) {
            plPlayerController
              ..keepControlsVisible = keepWindowControls
              ..controls = true;
          },
          onHover: (_) {
            plPlayerController
